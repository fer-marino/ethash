...
static inline void keccakf1600_implementation(uint64_t state[25]) {
...
static inline void keccak(uint64_t *out, size_t bits, const uint8_t *data, size_t size) {
    ...
    auto *last_word_iter = (uint8_t *) &last_word;
